...
public class E02StringMethod3 {
	...
	public static void main(String[] args) {
		...
		/*
		구분자로 사용한 문자열이 포함되어있지 않은 경우에는 문자열 전체가 통째로 반환되어 
		배열의 크기는 1이 된다.
		 */
		...
		/*
		14] substring() : 시작인덱스와 마지막 인덱스 사이의 문자열을 잘라서 반환
				방법1 : 인덱스를 하나만 사용 => 인덱스부터 문자열의 끝까지 잘라낸다.
				방법2 : 시작인덱스, 종료인덱스 사용 => 인덱스에 해당하는 부분만 잘라서 반환한다.
		 */
