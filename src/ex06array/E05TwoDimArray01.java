...
public class E05TwoDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		아래와 같이 2차원배열을 초기화하면 3행(세로), 4열(가로)인 배열이 생성된다.
		초기화 할 원소가 없는 부분은 null로 채워진다.
		※null값 :아무것도 없는 값을 말한다. 즉 비어있는 값을 말한다.
				스페이스와 같은 공백문자 호긍ㄴ 0과는 다르므로 명확한 의미를
				알고 있어야한다.
		 */
		...
		// 0번 인덱스는 1이 출력
		System.out.println("arr2[0] 출력: " + arr2[0]);
		// 초기화 하지 않은 원소는 0이 출력된다.
		System.out.println("arr2[3] 출력: " + arr2[3]);
