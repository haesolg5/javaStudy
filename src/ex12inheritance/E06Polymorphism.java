...
class MyChild extends MyParent{
	...
	void parentMethod() {
		System.out.println
		("자식에서 Overriding한 메소드 parentMethod()");
	}
	/*
	...
	void parentMethod(int childMember) {
		...
		System.out.println
		("Overloading:자식에서 확장한 메소드: parentMethod(param1)");
	}
}
...
public class E06Polymorphism {
	...
	public static void main(String[] args) {
		...
		/*
		이질화 : 부모타입의 변수로 자식 인스턴스를 참조하는 것을 말한다.
...
//		parent1.childMember = 1;
		...
		Object의 참조변수로 참조가 가능하다. 또한 Object 클래스에 정의된 모든 메서드를 별도의
