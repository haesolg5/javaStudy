...
public class Ex05Finally {
	...
	static void tryCatchFinally() {
		...
		try {
			...
			age =  scan.nextInt(); //30살과 같이 입력하며 예외 발생
			...
			/*
			try절에서 예외 발생과 상관없이 혹은 return을 만나더라도
			항상 finally절은 실행된다. */
	...
	public static void main(String[] args) {
		...
		/*
		이와 같은 예외는 발생된 지점에서 예외던지기를 하는것은 가능하지만,
		반드시 예외처리 해야만 프로그램이 종료되지 않는다.
		즉 예외객체에 따라 무시할 수 있는것도 있지만, 이처럼
		반드시 예외처리를 해야한는것도 존재한다.
		만약 main에서 throws로 기술하면 프로그램은 비정상적으로 종료된다. ㅜㅜㅜ */
		try {
			runtime();
		}
