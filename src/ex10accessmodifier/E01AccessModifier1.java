...
/*
해당 클래스의 접근지정자는 생략했으므로 defualt 클래스로 정의된다.
...
public으로 정의하는 경우 다른 패키지에서도 접근을 허용하게 되므로 하나의 Java 파일에 하나의 class만
정의하는 것을 권장한다.
 */
public class E01AccessModifier1 {
	...
	public void publicMethod() {
		...
		/*
		private으로 선언된 메서드도 클래스 내부에서는 호출할 수 있따.
		멤버변수와 동일한 접근범위를 가진다.
		 */
		privateMethod();
	}
